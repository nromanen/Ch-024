        ...
        var RegistrationUserModel = Backbone.Model.extend({
            ...
            validateName: function(value) {
                ...
                return (this.value.search(this.regex.PATTERN_NAME) !== -1 &&
                        this.value.length >= this.regex.NAME_LENGTH);
            },
            ...
            validateEmail: function(value) {
                this.value = value;
                return (this.value.search(this.regex.PATTERN_MAIL) !== -1);
            },

            validatePassword: function(value) {
                this.value = value;
                return (this.value.length >= this.regex.PASS_LENGTH);
            },

            validateRepeatPassword: function(value, password) {
                this.value = value;
                this.password = password;
                return (this.value === this.password && this.value !== '');
            },

            validatePhone: function(value) {
                this.value = value;
                return (this.value.search(this.regex.PATTERN_PHONE) !== -1);
            },
